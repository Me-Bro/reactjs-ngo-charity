...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='bg-gradient-to-l from-violet-900
        via-violet-800 to-violet-900 text-white fixed top-0 left-0 w-full
         border-b-[1px] border-primary/50'>
                 ...
                 <div className='hidden md:block'>
                    ...
                    <li className='group relative cursor-pointer'>
                        ...
                        <div className='absolute -left-9 z-[99999]
                         hidden w-[150px] bg-white shadow-md p-2
                    ...
                    <li>
                        <div className='flex items-center gap-4'>
                            {/* icon here */}
                            <div>
                            <BiPhoneCall className='text-2xl h-[40px]
                              w-[40px] rounded-md text-white bg-primary
                              hover:bg-primary/90 p-2' />
                            </div>
                            {/* Mobile no. */}
                            <div>
                               <p>Talk to us</p>
